...
namespace OnlineGradebook.DataAccess.Repositories;

public class Repository<T> : IRepository<T> where T : BaseEntity
{
    private readonly IDbContextFactory<OnlineGradebookDbContext> _contextFactory;

    public Repository(IDbContextFactory<OnlineGradebookDbContext> contextFactory)
    {
